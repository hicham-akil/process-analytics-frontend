    ...
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <p className="text-xl font-bold text-slate-200 font-mono">{stats.avg.toFixed(2)}</p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className="text-sm font-bold text-slate-400 font-mono">{stats.min.toFixed(2)}</p>
        </div>
        <div>
          <p className="text-[8px] text-slate-600 uppercase font-bold mb-0.5">Maximum</p>
          <p className="text-sm font-bold text-slate-400 font-mono">{stats.max.toFixed(2)}</p>
        </div>
      </div>
    </div>
  );
