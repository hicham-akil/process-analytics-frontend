        ...
        <main className="flex-1 overflow-y-auto p-8 ml-16 bg-background-base">
          {!latest && (
            <div className="flex flex-col items-center justify-center h-[60vh] text-text-muted space-y-4">
              ...
              <p className="text-sm font-medium tracking-widest uppercase">Acquisition des débits de production...</p>
            </div>
          )}
          ...
          {latest && (
            <div className="max-w-7xl mx-auto space-y-10 animate-fade-slide-up">
              ...
              <section>
                <SectionHead icon={<Factory size={16} />} label="Débits de Production Actuels" />
                <ProductionKPICards data={latest} />
              </section>

              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2">
                  <SectionHead icon={<BarChart3 size={16} />} label="Évolution des Débits (T/h)" />
                ...
                <div>
                  ...
                  <div className="bg-background-cards border border-border-subtle rounded-xl p-6 space-y-8 shadow-lg">
                    <StatGroup label="P₂O₅ 29% (T/h)" stats={stats.qP2o529} accent="text-accent-cyan" />
                    <div className="h-px bg-border-subtle" />
                    <StatGroup label="P₂O₅ 54% (T/h)" stats={stats.qP2o554} accent="text-accent-blue" />
                  </div>
                </div>
              </div>
              ...
              <footer className="pt-12 pb-6 border-t border-border-subtle flex justify-between items-center text-[10px] font-bold text-text-muted uppercase tracking-widest">
                <span>© 2026 JFC3 Production Analytics</span>
                <div className="flex gap-6">
                  <span>Performance Industrielle</span>
